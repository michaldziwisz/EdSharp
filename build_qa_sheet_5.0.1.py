...
CASES = [
    ...
    ["PREVIEW-001", "Podglad z synchronizacja (Escape)", "P1",
     ...
     "Escape przelacza podglad/edycje. W tym trybie kursor edycji PODAZA za kursorem w podgladzie (synchronizacja jak dotad). NVDA oglasza 'Review' / 'Edit'.",
     None, None, BUILD],
    ["PREVIEW-002", "Podglad ODCZEPIONY bez synchronizacji (Shift+Escape)", "P1",
     ...
     "NVDA oglasza 'Review detached'. Ruch w podgladzie NIE przenosi kursora edycji. Po Shift+Escape kursor edycji jest DOKLADNIE tam, gdzie przed wejsciem w podglad.",
     None, None, BUILD],
    ...
    ["BUILD-001", "Uruchomienie i wersja", "P1",
     "Nowa galaz edsharp5-consolidated (5.0 beta + nasze 5 funkcji + 4 zadania).",
     "Sanity",
     "1. Zainstaluj EdSharp_Setup.exe. 2. Uruchom EdSharp (Alt+Ctrl+E). 3. Sprawdz Help > About.",
     "Aplikacja startuje na Windows 10+/x64 (i ARM64), NVDA czyta interfejs, brak bledow startowych.",
     None, None, BUILD],
]

INSTRUKCJA = [
    ["Artefakt", "EdSharp_Setup.exe (Inno Setup, x64/ARM64). Baza: EdSharp 5.0 beta + nasze funkcje."],
    ["Wersja", WERSJA + " (galaz edsharp5-consolidated)"],
    ["Cel", "Retest 4 zadan z 'Do zrobienia 2026-08-04.md' + regresja skonsolidowanych funkcji po przejsciu na baze 5.0."],
    ["Statusy", "PASS = dziala, FAIL = blad, BLOCKED = brak warunkow, N/A = nie dotyczy."],
    ["Uwaga jezykowa", "Aplikacja po angielsku; arkusz po polsku. Komunikaty (Heading, Review detached, List copied, Top!) zostaja po angielsku."],
